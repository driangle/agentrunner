...
- [x] Initialize the package (`pyproject.toml`, package structure)
- [x] Implement core runner that spawns and manages the CLI process
- [x] Define Python types/dataclasses for CLI inputs and outputs
